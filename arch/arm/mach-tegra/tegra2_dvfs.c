...
static const int cpu_millivolts[MAX_DVFS_FREQS] =
	{700, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1100, 1125};
...
static struct dvfs dvfs_init[] = {
	...
	CPU_DVFS("cpu", 1, 0, MHZ, 164, 216, 312, 456, 608, 760,  816,  912,  1000,  1200),
	CPU_DVFS("cpu", 1, 1, MHZ, 164, 216, 312, 456, 608, 760,  816,  912,  1000,  1200),
